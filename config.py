...
LVLM_MODEL_NAME = "HuggingFaceTB/SmolVLM2-2.2B-Instruct" #"Qwen/Qwen2-VL-2B-Instruct""openbmb/MiniCPM-V-2"#"llava-hf/llava-1.5-phi-2-hf"#"Qwen/Qwen2-VL-2B-Instruct"
